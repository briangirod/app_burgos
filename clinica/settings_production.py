"""
Configuración de producción para App Burgos
...
ALLOWED_HOSTS = [
    'ffmpeg-appburgos.blzx1p.easypanel.host',
    'localhost',
    '127.0.0.1',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'app_burgos_prod'),
        'USER': os.environ.get('DB_USER', 'postgres'),
        'PASSWORD': os.environ.get('DB_PASSWORD', ''),
        'HOST': os.environ.get('DB_HOST', 'localhost'),
        'PORT': os.environ.get('DB_PORT', '5432'),
        'OPTIONS': {
            'MAX_CONNS': 20,  # Pool de conexiones
        }
    }
}
...
# Sessions en Redis para escalabilidad
...
CSRF_TRUSTED_ORIGINS = [
    "https://ffmpeg-appburgos.blzx1p.easypanel.host",
]
...
# Configuración de email para errores
...
ADMINS = [
    ('Admin', os.environ.get('ADMIN_EMAIL', 'admin@appburgos.com')),
]
